...
export function Header() {
  return (
    <header className="flex w-full bg-indigo-800 h-12 items-center justify-center">
      ...
      <div className="flex-1 h-8 items-center justify-center rounded-md bg-indigo-200">
        ...
        <div className="relative shadow-sm h-full">
          ...
          <input
            ...
            name="search"
            id="search"
            className="bg-transparent w-full h-full pl-8 pr-8 sm:text-sm rounded-md focus:bg-white focus:outiline-0 placeholder:text-indigo-800"
