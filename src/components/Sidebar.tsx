    ...
    <div className="flex w-[68px] md:max-w-[428px] md:w-full">
      <div className="flex flex-col w-[68px] items-center justify-between">
        <div className="flex flex-col items-center justify-center w-full p-[2px] text-neutral-600">
          ...
          <button className="flex flex-col w-full h-[56px] items-center justify-center py-[1px] hover:bg-slate-50 hover:text-indigo-700">
        ...
        <div className="flex flex-col items-center justify-center w-full p-[5px] text-neutral-600 gap-2 mb-4">
          ...
          <button className="flex flex-col w-full items-center justify-center py-3 hover:bg-indigo-800 bg-indigo-700 rounded">
            <ArrowLineDown size={24} color="#ffffff" weight="light" />
          </button>
        </div>
      </div>
      <Chatlist />
